 ...
 * @param stationClass
 */
case class FdClass(transmitters: Int = 1, classLetter: Char = 'I') derives Codec.AsObject:
...
case class Exchange(fdClass: FdClass = FdClass(), sectionCode: String = "IL") derives Codec.AsObject:
